...
| arguments | `read.csv(file = "datasets/tv_shows.csv", header = FALSE)`| Components of a function that are separated by commas and declared using the `=` sign. |
...
# Barplot the first 10 rows of tv data 
ggplot(sorted_tv_data[1:10,], aes(x=Title, y=IMDb)) + geom_bar(stat = "identity")
...
| `print(sorted_tv_data[1:10,])` | Print out the top 10 IMDb rated shows | 
